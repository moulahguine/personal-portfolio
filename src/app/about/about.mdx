...
<section id="introduction" className={styles["page__about-section"]}>

## Who I am

Hi, I'm Mohamed. I'm a frontend developer from Morocco, currently studying Software Engineering in Türkiye.

<figure className={styles["page__about-media"]}>
  <Image
    src={myimage}
    alt="me looking out over the Bosphorus in Istanbul"
    width={300}
    height={300}
    ...
    priority
    placeholder="blur"
    className={styles["page__about-media--img"]}
  />
</figure>
...
<section id="discovering-programming" className={styles["page__about-section"]}>
...
<section id="frontend" className={styles["page__about-section"]}>
...
<section id="first-client" className={styles["page__about-section"]}>
...
<section id="software-engineering" className={styles["page__about-section"]}>
...
<section id="software-values" className={styles["page__about-section"]}>
...
<section id="community" className={styles["page__about-section"]}>
...
<section id="outside-code" className={styles["page__about-section"]}>
...
<section id="whats-next" className={styles["page__about-section"]}>
